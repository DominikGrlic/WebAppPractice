...
namespace SimpleWebApp.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<AppUser> userManager, IEmailSender emailSender, IEmailConfirmSender emailConfirmSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var resp = await _emailConfirmSender.SendEmailPassResetAsync(Input.Email, link);
